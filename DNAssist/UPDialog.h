...
public:
	...
	LPVOID m_pDialogText;	//Fill up with the label text of the DialogBox
...
public:
	...
	inline LPCWSTR GetStatus() const
	{ 
		auto pStatusText = (wstring*) this->m_pDialogText;
		return pStatusText->c_str();
	}
...
public:
	...
	CUPDialog(HWND hParentWnd,LP_CUPDIALOG_USERPROC lpUserProc,LPVOID lpUserProcParam, wstring* lpszDlgTitle, bool bAllowCancel=true);
